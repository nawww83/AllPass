...
Генерируемые пароли могут быть длиной от 10 до 50 печатаемых ASCII-символов. В зависимости от уровня сложности символы могут быть:

1. Простой: буквы латинского алфавита [aA-zZ] и цифры [0-9].

2. Сложный: буквы латинского алфавита и цифры + специальные символы с ascii-кодами [33, 47].

Иконки для кнопок взяты с https://icons8.ru

Сборка и запуск программы проверялись под Windows 11.
...
### Версия 1.09, 31.12.2025

* Добавлен выбор сложности пароля: простой/сложный.

### Версия 1.10, 22.02.2026

* Улучшен алгоритм вычисления CRC: сильнее и быстрее.

### Версия 2.00, 15.03.2026

* Убрал легаси код. Версии 1.** не поддерживаются.

* Переработан хэш lfsr128sum.

### Версия 2.01, 26.07.2026

* Перевел на версию Qt 6.11.1.
